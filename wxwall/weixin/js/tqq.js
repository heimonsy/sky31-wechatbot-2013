...
{
	tf++;
	str = "<div id=\"jiang_pg\"><img width=\"140\" height=\"140\" src=\""+userList[upi].purl+"\"></div> <div id=\"user_info\">微信号：<br>昵称：</div><div class=\"u_inf\">"+userList[upi].wxn+"<br>"+userList[upi].nname+"</div>";
...
function setMsgContent(msgList, start)
{
	...
	while( l<3){
		...
		*/
		str+="<div class=\"msgs\"><div class=\"smsg\"><div class=\"img\"><img src=\""+msgList[start].purl+"\" width=\"140\" height=\"140\"/></div>";
