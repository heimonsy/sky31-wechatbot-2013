...
// 	function isRightStuPw($userName, $pw)
// 	{
// 		$ch = self::loginToStuM($userName,$pw);
// 		curl_setopt($ch, CURLOPT_URL, "http://202.197.224.134:8083/jwgl/index1.jsp");
// 		$str = curl_exec($ch);
// 		return $str;
// 	}
...
// $start = PostLogin::microtime_float();
// $userName = "2011960509";
// $password = "123456";
// $r = PostLogin::getKb($userName, $password);
// if( $r ) echo print_r($r);
// else echo "error";
// $end = PostLogin::microtime_float();
// echo $end-$start;

//echo PostLogin::isRightStuPw('2011960509', '123456');
